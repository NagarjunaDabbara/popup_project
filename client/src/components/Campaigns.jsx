...
export default function Campaigns() {
  ...
  const tableHeads = [
    { name: "#" },
    { name: "NAME", sortField: "domainName" },
    { name: "RECIPIENTS GROUPS", sortField: "apiKey" },
    { name: "CREATED BY", sortField: "emailLimit" },
    { name: "LAST UPDATED", sortField: "emailLimit" },
    { name: "START DATE", sortField: "emailLimit" },
    { name: "START TIME", sortField: "emailLimit" },
    { name: "ELASPED TIME", sortField: "emailLimit" },
    { name: "SENT/TOTAL", sortField: "emailLimit" },
    { name: "CLICK", sortField: "emailLimit" },
    { name: "VIEW", sortField: "emailLimit" },
    { name: "Status" },
    { name: "Action" },
  ];
  ...
  return (
    <div>
      ...
      <table className="table table-striped">
        ...
        <tbody>
          {data.campaingsLists.map((post) => (
            <tr>
              <td key={post.id}>{post.snum}</td>
              <td>{post.name}</td>
              <td>{post.recipientGroups}</td>
              <td>Gopi Krishna Vellanki</td>
              <td>NA</td>
